...
abstract class AppStatusListenerSuite extends SparkFunSuite with BeforeAndAfter {
  ...
  test("scheduler events") {
    ...
    time += 1
    val stages = Seq(
      new StageInfo(1, 1, 0, "stage1", 4, Nil, Nil, "details1",
        resourceProfileId = ResourceProfile.DEFAULT_RESOURCE_PROFILE_ID),
      new StageInfo(2, 2, 0, "stage2", 4, Nil, Seq(1), "details2",
        resourceProfileId = ResourceProfile.DEFAULT_RESOURCE_PROFILE_ID))
    ...
    val newS2 = new StageInfo(oldS2.stageId, oldS2.stageKey, oldS2.attemptNumber + 1, oldS2.name, oldS2.numTasks,
    ...
    time += 1
    val j2Stages = Seq(
      new StageInfo(3, 3, 0, "stage1", 4, Nil, Nil, "details1",
        resourceProfileId = ResourceProfile.DEFAULT_RESOURCE_PROFILE_ID),
      new StageInfo(4, 4, 0, "stage2", 4, Nil, Seq(3), "details2",
        resourceProfileId = ResourceProfile.DEFAULT_RESOURCE_PROFILE_ID))
  ...
  test("storage events") {
    ...
    val rdd1b1 = RddBlock(1, 1, 1, 1L, 2L)
    val rdd1b2 = RddBlock(1, 2, 2, 3L, 4L)
    val rdd2b1 = RddBlock(2, 1, 1, 5L, 6L)
    ...
    val rdd1Info = new RDDInfo(rdd1b1.rddId, rdd1b1.rddKey, "rdd1", 2, StorageLevel.NONE, false, Nil)
    val stage0 = new StageInfo(0, 0, 0, "stage0", 4, Seq(rdd1Info), Nil, "details0",
      resourceProfileId = ResourceProfile.DEFAULT_RESOURCE_PROFILE_ID)
    ...
    val rdd2Info = new RDDInfo(rdd2b1.rddId, rdd2b1.rddKey, "rdd2", 1, level, false, Nil)
    val stage = new StageInfo(1, 1, 0, "stage1", 4, Seq(rdd1Info, rdd2Info), Nil, "details1",
      resourceProfileId = ResourceProfile.DEFAULT_RESOURCE_PROFILE_ID)
  ...
  test("eviction of old data") {
    ...
    val stages = Seq(
      new StageInfo(1, 1, 0, "stage1", 4, Nil, Nil, "details1",
        resourceProfileId = ResourceProfile.DEFAULT_RESOURCE_PROFILE_ID),
      new StageInfo(2, 2, 0, "stage2", 4, Nil, Nil, "details2",
        resourceProfileId = ResourceProfile.DEFAULT_RESOURCE_PROFILE_ID),
      new StageInfo(3, 3, 0, "stage3", 4, Nil, Nil, "details3",
        resourceProfileId = ResourceProfile.DEFAULT_RESOURCE_PROFILE_ID))
    ...
    val attempt2 = new StageInfo(3, 3, 1, "stage3", 4, Nil, Nil, "details3",
      resourceProfileId = ResourceProfile.DEFAULT_RESOURCE_PROFILE_ID)
    time += 1
  ...
  test("eviction should respect stage completion time") {
    ...
    val stage1 = new StageInfo(1, 1, 0, "stage1", 4, Nil, Nil, "details1",
      resourceProfileId = ResourceProfile.DEFAULT_RESOURCE_PROFILE_ID)
    val stage2 = new StageInfo(2, 2, 0, "stage2", 4, Nil, Nil, "details2",
      resourceProfileId = ResourceProfile.DEFAULT_RESOURCE_PROFILE_ID)
    val stage3 = new StageInfo(3, 3, 0, "stage3", 4, Nil, Nil, "details3",
      resourceProfileId = ResourceProfile.DEFAULT_RESOURCE_PROFILE_ID)
  ...
  Seq(true, false).foreach { live =>
    test(s"Total tasks in the executor summary should match total stage tasks (live = $live)") {
      ...
      val stage = new StageInfo(1, 1, 0, "stage", 4, Nil, Nil, "details",
        resourceProfileId = ResourceProfile.DEFAULT_RESOURCE_PROFILE_ID)
  ...
  test("storage information on executor lost/down") {
    ...
    // Submit a stage and make sure the RDDs are recorded.
    val rdd1Info = new RDDInfo(rdd1b1.rddId, rdd1b1.rddKey, "rdd1", 2, level, false, Nil)
    val stage = new StageInfo(1, 1, 0, "stage1", 4, Seq(rdd1Info), Nil, "details1",
      resourceProfileId = ResourceProfile.DEFAULT_RESOURCE_PROFILE_ID)
    listener.onStageSubmitted(SparkListenerStageSubmitted(stage, new Properties()))
