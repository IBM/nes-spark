...
#DRIVER_JAVA_OPTIONS="-Dsun.nio.PageAlignDirectMemory=true -Xdebug -agentlib:jdwp=transport=dt_socket,server=y,suspend=y,address=*:5005"
...
${SPARK_HOME}/bin/spark-submit \
    ...
    --name ce-sql-$SIZE-$PROCESS_TAG-${INSTANCES}x${EXECUTOR_CPU}--$EXECUTOR_MEM \
    ...
    --conf spark.eventLog.dir="$LOGS_DATA_PREFIX/test-custom-spark-tpcds-sql-$2-sf${SIZE}-ex${INSTANCES}" \
