...
# Define Spark dynamic executors configurations
DYNAMIC_CONFIG=(
...
${SPARK_HOME}/bin/spark-submit \
    ...
    --name ce-tpch-$SIZE-$PROCESS_TAG-dyn-$EXECUTOR_MEM \
    ...
    --conf spark.eventLog.dir="$LOGS_DATA_PREFIX/tpch-$2-sf${SIZE}-dyn${MIN_EXECUTORS}to${MAX_EXECUTORS}-test" \
