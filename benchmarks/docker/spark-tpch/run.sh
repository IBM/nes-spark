...
${SPARK_HOME}/bin/spark-submit \
    ...
    --conf spark.eventLog.dir="$LOGS_DATA_PREFIX/tpch-$2-sf${SIZE}-ex${INSTANCES}-test" \
    ...
    /home/nes/intelligent-scale-out/benchmarks/docker/spark-tpch/jars/spark-tpc-h-queries_2.12-1.0.jar \
    "$@"
